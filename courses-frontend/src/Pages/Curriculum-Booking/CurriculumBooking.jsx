        ...
        <div className="w-full">
          ...
          <div className="hidden md:flex items-center w-full pt-6 md:pt-8">
            <nav className="text-sm flex items-center gap-2 text-gray-600">
              <Link to="/" className="flex items-center gap-2 hover:underline">Home <ChevronRight size={18}/></Link>
              <Link to={`/?category=${singleCurriculum?.category}`} className="flex items-center gap-2 hover:underline">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-5 sm:gap-6 mt-[32px] h-fit w-full items-start">
            ...
            <div className="w-full bg-[#E9EAEE] rounded-[24px] p-5 sm:p-6 shadow-none flex flex-col space-y-6 h-fit xl:max-h-[calc(100vh-190px)] xl:overflow-y-auto overflow-x-hidden custom-scrollbar">
              {/* Description Section */}
              <div className="w-full">
